...
//        holder.binding.companyNameTxt.setText(job.getCompany().getCompany_size());
//        holder.binding.jobTitleTxt.setText(job.getTitle());
////        holder.binding.sortAddressesTxt.setText(job.getSort_addresses());
//        Glide.with(context).load(job.getCompany().getImage_logo()).into(holder.binding.companyLogo);
    }
